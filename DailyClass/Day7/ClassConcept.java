...
public class ClassConcept {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.println("클래스의 동작(Behavior) == 메소드");
		...
		System.out.println("사람을 객체로 표현 했을 때, 자기 소개를 한다, 공부를 한다 같은 것들은 메소드라고 할 수 있습니다.");
		
		System.out.println("클래스의 선언 방법은 [접근범위] [활용제한자] [객체타입] 클래스이름 ( [매개변수] ) { ... } 과 같은 형식입니다. ");
		...
		System.out.println("생성자는 객체를 생성할때 실행되는 생성자 입니다. new 키워드와 함께 호출되며 클래스 이름과 동일합니다."); // hint6. 마지막 밑줄은 영문(alphabet)입니다.
